...
RUN mkdir /opt/mcr_install \
 && mkdir /opt/mcr \
 && wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/${MATLAB_VERSION}/Release/${MCR_UPDATE}/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_${MATLAB_VERSION}_Update_${MCR_UPDATE}_glnxa64.zip \
...
# TODO see https://www.mathworks.com/help/compiler/mcr-path-settings-for-run-time-deployment.html
