...
RUN mkdir /opt/mcr_install \
 && mkdir /opt/mcr \
 && wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/${MATLAB_VERSION}/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_${MATLAB_VERSION}_glnxa64.zip \
